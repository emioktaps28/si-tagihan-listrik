...
<html>
    <head>
        <title>Cetak Data Pelanggan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2>Sistem Informasi Pembayaran Tagihhan Listrik Pascabayar </h2>
                        <h4>East Aek Kanopan, Kualu Hulu, Labuhan Batu Utara <br> Kabupaten labuhan Batu, Sumatera Utara, 21273</h4>
                        <hr>
                        <h3>DATA PELANGGAN PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                      ...
                      <th width="14%"><center>Tarif/Daya</center></th><th width="14%"><center>Tanggal Masuk</center></th><th width="10%"><center>Periode</center></th><th><center>Status</center></th>
                            ...
                            $sql = "SELECT * FROM tb_pelanggan WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
