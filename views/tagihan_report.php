        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Tagihan Listrik</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                                <tr>
                                    <th>No.</th><th width="17%">IDPEL</th><th width="14%">Nama</th><th width="14%">Periode</th><th width="10%">Tanggal Bayar</th>
                                    <th width="14%">Rp Admin</th><th width="14%">Rp Tagihan</th><th width="14%">Rp Bayar</th><th>AKSI</th>
                                </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/tagihan_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/tagihan_semua.php" target="_blank" class="btn btn-info btn-sm">
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/tagihan_perbulan.php" method="post">
        <h4>Pilih bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/tagihan_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?php
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
