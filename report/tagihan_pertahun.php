...
<html>
    <head>
        <title>Cetak Data Tagihan Listrik Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA TAGIHAN LISTRIK PERTAHUN   <? echo "$ambilthn"; ?></h3>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM tagihan WHERE substr(tgl_bayar,1,4)='$ambilthn'";
